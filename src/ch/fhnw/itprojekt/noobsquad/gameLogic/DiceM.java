...
public class DiceM implements Serializable{
	 ...
	 *  Dies ermöglicht die Auswertung auf Wuerfelkombinationen, damit der
	 * 	Spielzug ausgewertet werden kann.
	 * @param value
	 * @return counter
	 */
	 ...
	 *  Dies wird so gemacht, damit der Spieler die Wuerfel auswählen und sperren kann, 
	 *  bevor er erneut wuerfelt
	 **/
	...
	/**
	 *  Getter für das WuerfelBild. 
	 *  Unterscheidet, ob der Wuerfel gesperrt ist oder nicht, um das passende
	 *  Bild zurück zu geben.
	 * @param id
	 * @return facePicture
	 */
	...
	/**
	 * Getter für die Länge des DiceM Objektes.
	 * Wird benutzt für gewisse for Schleifen.
	 * @return size
	 */
	public int getSize(){
